...
commonPipelineForGolang(
    ...
    environment: [
        ...
        DEPLOY_TARGET_FILE : "app-charts-live/collectionview-service/values-stage.yaml",
        DEPLOY_TARGET_FILE_LIVE : "app-charts-live/collectionview-service/values-stage.yaml",
        DEPLOY_TARGET_BRANCH : "main",
        REGISTRY : "537984406465.dkr.ecr.ap-south-1.amazonaws.com",
        REPOSITORY : "collectionview-service",
